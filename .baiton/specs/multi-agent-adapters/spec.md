...
- [executed] T05 Export the new adapters from src/adapter/index.ts and add an adapter registry keyed by agent id (claude/opencode/antigravity/codex -> Adapter instance) (after T02, T03, T04; files: src/adapter/index.ts)
