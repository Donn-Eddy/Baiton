...
- [planned] T02 Add src/adapter/opencode.ts implementing Adapter for the opencode CLI (probe/launch/attach per the opencode findings, including the missing --add-dir degrade) (after T01; files: src/adapter/adapter.ts, src/adapter/claude.ts, src/adapter/permissions.ts)
