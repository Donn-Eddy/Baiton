...
- [executing] T08 Extend package.json's baiton.agents.<agent>.path settings with opencode, antigravity, and codex entries (executable overrides), consistent with the existing baiton.agents.claude.path setting (after T01; files: package.json)
