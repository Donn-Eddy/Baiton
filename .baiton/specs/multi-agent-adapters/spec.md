...
- [planning] T03 Add src/adapter/antigravity.ts implementing Adapter for the agy CLI (probe/launch/attach per the antigravity findings) (after T01; files: src/adapter/adapter.ts, src/adapter/claude.ts, src/adapter/permissions.ts)
